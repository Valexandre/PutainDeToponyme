...
rtweet::post_tweet(token = tweetbot_token, status = paste0("Salut les glandus. Aujourd'hui, découvrons ",Commune,". #VillesDeLaTourette"),
                  media=img,alt_text=paste0("Carte de ",Commune))
